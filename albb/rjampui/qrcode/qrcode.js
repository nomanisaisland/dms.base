...
MpSimpleState_1.MpSimpleState.Component({
    ...
    onInit: function () {
        var component = this;
        var canvasId = RandomUtil_1.RandomUtil.guidStringN();
            ...
            copy: function () {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, rjMy_1.rjMy.setClipboard({
                                    text: state.text,
                                })];
                            case 1:
                                _a.sent();
            ...
            draw: function () {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                drawText = JSON.stringify({
                                    text: state.text,
                                    width: state.width,
                                    height: state.height,
                                });
                                if (!(drawText !== state.drawText)) return [3 /*break*/, 2];
                                state.drawText = drawText;
                                return [4 /*yield*/, stateControl.update()];
                            case 1:
                                _a.sent();
                                console.log({
                                    text: state.text,
                                ...
                                (0, qrcodeCanvas_1.qrcodeCanvas)(state.canvasId, {
                                    text: state.text,
                                    width: state.width,
                                    height: state.height,
                                    correctLevel: 1,
