 ...
 */
var QRMode = { MODE_NUMBER: 1 << 0, MODE_ALPHA_NUM: 1 << 1, MODE_8BIT_BYTE: 1 << 2, MODE_KANJI: 1 << 3 }, QRErrorCorrectLevel = { L: 1, M: 0, Q: 3, H: 2 }, QRMaskPattern = {
    PATTERN000: 0,
    PATTERN001: 1,
    PATTERN010: 2,
    PATTERN011: 3,
...
var QRCodeModel = /** @class */ (function () {
    function class_1(typeNumber, errorCorrectLevel) {
    ...
    class_1.prototype.addData = function (data) {
        var newData = new QR8bitByte(data);
        this.dataList.push(newData);
        this.dataCache = null;
    };
    class_1.prototype.isDark = function (row, col) {
        if (row < 0 || this.moduleCount <= row || col < 0 || this.moduleCount <= col) {
            throw new Error(row + ',' + col);
        }
        return this.modules[row][col];
    };
    class_1.prototype.getModuleCount = function () {
        return this.moduleCount;
    };
    class_1.prototype.make = function () {
        this.makeImpl(false, this.getBestMaskPattern());
    };
    class_1.prototype.makeImpl = function (test, maskPattern) {
    ...
    class_1.prototype.setupPositionProbePattern = function (row, col) {
        for (var r = -1; r <= 7; r++) {
    ...
    class_1.prototype.getBestMaskPattern = function () {
    ...
    class_1.prototype.setupTimingPattern = function () {
    ...
    class_1.prototype.setupPositionAdjustPattern = function () {
    ...
    class_1.prototype.setupTypeNumber = function (test) {
    ...
    class_1.prototype.setupTypeInfo = function (test, maskPattern) {
    ...
    class_1.prototype.mapData = function (data, maskPattern) {
...
var QRRSBlock = /** @class */ (function () {
    function class_2(totalCount, dataCount) {
...
var Drawing = /** @class */ (function () {
    function Drawing(el, opts) {
        this._opts = opts;
        this._el = el;
        this._ctx = my.createCanvasContext(el);
    }
    Drawing.prototype.draw = function (QRCode) {
        var ctx = this._ctx, opts = this._opts;
        var count = QRCode.getModuleCount(), width = opts.width / count, height = opts.height / count, roundedWidth = Math.round(width), roundedHeight = Math.round(height);
        this.clear();
        for (var row = 0; row < count; row++) {
            for (var col = 0; col < count; col++) {
                var isDark = QRCode.isDark(row, col), left = col * width, top_1 = row * height;
                ctx.setStrokeStyle(isDark ? opts.colorDark : opts.colorLight);
                ctx.setLineWidth(1);
                ctx.setFillStyle(isDark ? opts.colorDark : opts.colorLight);
                ctx.fillRect(left, top_1, width, height);
                ctx.strokeRect(Math.floor(left) + 0.5, Math.floor(top_1) + 0.5, roundedWidth, roundedHeight);
                ctx.strokeRect(Math.ceil(left) - 0.5, Math.ceil(top_1) - 0.5, roundedWidth, roundedHeight);
            }
        }
        ctx.draw();
...
var QRCode = (function () {
    ...
    var Fn = /** @class */ (function () {
        ...
        class_3.prototype.makeCode = function (text) {
...
var qrcodeCanvas = function (el, opts) {
    return new QRCode(el, opts);
};
